  ...
  return (
    <div className='w-full pt-8'>
      ...
      <div className='w-full bg-darkcyan'>
        <MaxWidthWrapper className='flex flex-col justify-between items-center animate-fade text-white text-start sm:pt-8'>
          <div className='flex sm:flex-col sm:m-8'>
            {/* Contact Info */}

            <div className='lg:px-24 md:px-4 sm:pb-8 lg:w-6/12 md:w-6/12'>
              ...
              <div className='py-2 flex items-center'>
                <FontAwesomeIcon
                  ...
                  style={{color: "#ffffff"}}
                />
                <p className='pl-4'>Phone: +1-543-123-4567</p>
              </div>
            ...
            <div className='lg:pl-28 md:pl-4 sm:pb-8 lg:w-6/12 md:w-6/12'>
              <div>
                <h1 className='lg:text-3xl md:text-3xl sm:text-xl'>
                  NEWSLETTER
                </h1>
                <p className='text-[0.84rem] pt-4 mr-32 text-sm md:mr-0 sm:mr-0'>
              ...
              <div className='flex justify-between pt-8 sm:flex-col'>
                <input
                  className='w-40 h-10 grow mr-8 rounded-md text-gray-500 pl-1 focus:outline-none focus:border-lightPink focus:ring-pink focus:ring-1 sm:w-full'
                  type='email'
                  name='subscribe'
                />
                <button className='w-32 h-10 text-white text-xs bg-pink border-pink border-2 rounded-md transition-all shadow-md font-semibold hover:shadow-none hover:scale-95 hover:border-lightPink hover:bg-lightPink sm:ml-auto sm:mt-6'>
                  Subscribe
                </button>
              </div>
            </div>
          ...
          {/* Socials */}
          <div className='flex w-full h-28 items-center lg:px-24 md:px-4 sm:w-10/12'>
            <FontAwesomeIcon
              icon={faSquareFacebook}
              className='text-white fa-2x hover:text-lightPink hover:scale-105 transition-all'
            />
            <FontAwesomeIcon
              icon={faInstagram}
              className='text-white fa-2x mx-4 hover:text-lightPink hover:scale-105 transition-all'
            />
            <FontAwesomeIcon
